...
public class NecessityCompactEpistemicState extends CompactEpistemicState {
	
	public NecessityCompactEpistemicState(AdvancedSet<BeliefAtom> atoms) throws Exception {
		super(atoms);
	}
	...
	public String toString() {
		...
		try {
			String delim = "";
			for(BeliefAtom a : this.getDomain()) {
				Weight w = this.getUpperPossibilityBound(a);
				if(w.getPositive() > 0) {
